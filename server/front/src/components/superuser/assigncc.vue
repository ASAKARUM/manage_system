...
export default {
  ...
  data() {
    return {
      /**
     * @prop {Boolean} showcclist 展示课程顾问列表
     * @prop {Object} stulist 待分配的学生列表
     * @prop {String} stu_id 当前选中的学生的编号
     */
      showcclist: false,
      stulist: [],
      stu_id: '',
