...
export default {
  ...
  data() {
    return {
      /**
     * @prop {String} initial 存储当前页面序号
     * @prop {String} name 当前用户姓名
     * @prop {String} user_type 当前用户类型
     * @prop {String} url 导入文件的路径
     */
      initial: '0',
      showindex: 1,
  ...
  methods: {
    ...
    /**
     * @function onEduAdminList
     * @description 展示教务老师列表模块
     */
    onEduAdminList() {
      this.showindex = 3;
    ...
    /**
     * @function onSellerList
     * @description 展示地推人员列表模块
     */
    onSellerList() {
      this.showindex = 5;
    ...
    /**
     * @function onCustomerList
     * @description 展示客户列表模块
     */
    onCustomerList() {
      this.showindex = 6;
      this.initial = '6';
    ...
    /**
     * @function onAddSeller
     * @description 展示添加地推人员模块
     */
    onAddSeller() {
      this.showindex = 9;
      this.initial = '9';
    ...
    /**
     * @function onSellerSales
     * @description 展示地推人员销售业绩模块
     */
    onSellerSales() {
      this.showindex = 13;
      this.initial = '13';
    ...
    /**
     * @function onTeacherSales
     * @description 展示试听课老师业绩
     */
    onTeacherSales() {
      this.showindex = 14;
      this.initial = '14';
